	...
	Chosen = (function () {
		...
		Chosen.prototype.result_add_option = function (option) {
			...
			if (!option.disabled) {
				...
				return '<li id="' + option.dom_id + '" title='+"'" + option.hint +"'"+ ' class="' + classes.join(' ') + '">' + option.html + '</li>';
			} else {
				return "";
			}
		};
		...
		Chosen.prototype.choice_build = function (item) {
			...
			this.choices += 1;
			this.search_container.before('<li class="search-choice" id="' + choice_id + '"><span>' + item.html + '</span><a title='+"'"+ item.hint+"'"+' href="javascript:void(0)" class="search-choice-close" rel="' + item.array_index + '"></a></li>');
